...
#Making sure that program is run as root
if os.geteuid() != 0:
...
defaultConfig = { "fileExtensions": [".txt",".json",".pdf"]
         ...
         , "maxLogFileDays": 10
         , "ScanPath": "/home/kali/Desktop/scanned/"
         }
#Serializing json
...
#Storing config.json lines into variables (If Program is already started, restart program to update variables)
def storeVariables():
...
def main():
    checkLogFileTime();
    print('+' + '='*50 + '+');
    print('                 \033[1;34;40mIntegrity Checker');
    print('                  By Brayden Park\033[1;37;40m');
    print('+' + '='*50 + '+');
    print('');
    checkIntegrity();
    time.sleep(5);
